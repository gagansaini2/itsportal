...
<html>
	...
	<body>
		...
		<header>
			...
			<div class="container">
				<div class="pull-left">
					<div id="logo"><a href="index.html"><img src="images/logo_new.png" alt="Jobseek - Job Board Responsive HTML Template" /></a></div>
				</div>
			...
			<div class="container">
				<div class="row ">
					<div class="col-lg-12">
                        ...
                        <ol>
                        <li style="font-size:18px;">DO YOU WANT TO WRITE YOUR RESUME ,ASK ONE SIMPLE QUESTION: <br>DO I NEED A JOB OR A NEW CAREER?<br>
                      
                      <strong>If most of these describe your present work, you are probably in the right career:</strong>s
                        <ul>
                        <li>Your work is a natural expression of your interest, talent and personality.</li>
                        <li> You look forward to going to work most of the time.</li>
                        <li>You are proud of what you do and enjoy telling other people about it.</li>
                        <li>You are highly respected at work because you are so good at what you do.</li>
                        <li>You do not have to pretend to be someone else at work.</li>
                        <li>Your own best and most natural forms of creative expression are what you are paid to do.</li>
                        ...
                        <li  style="font-size:18px;"> FOCUS ON THE EMPLOYER'S NEEDS, NOT YOURS :PLAN FIRST</li>
                        <li  style="font-size:18px;">THE EVIDENCE SECTION – HOW TO PRESENT YOUR WORK HISTORY, EDUCATION, ETC.</li>
                        <li  style="font-size:18px;">A FEW GUIDELINES FOR A BETTER PRESENTATION</li>
                        <li  style="font-size:18px;">ADD POWER TO YOUR RESUME WITH POWERWORDS</li>
                        </ol>
