...
--
-- Host: localhost
-- Generation Time: Jun 08, 2016 at 06:00 PM
...
INSERT INTO `tbl_employee_del` (`employee_id`, `user_id`, `name`, `email`, `phoneno`, `address`, `age`, `gender`) VALUES
...
(7, 0, 'Gagandeep Singh', 'asa', '07508767900', '#37, Guru Gobind Singh Av', 0, 'femal'),
...
CREATE TABLE IF NOT EXISTS `tbl_employee_exp` (
  ...
  `company_worked` varchar(25) NOT NULL,
...
INSERT INTO `tbl_employee_exp` (`employee_id`, `user_id`, `experience_yrs`, `key_skills`, `last_job`, `company_worked`, `current_salary`, `expected_salary`, `prefered_loc`) VALUES
