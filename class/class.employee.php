...
<form name="sub" method="POST" enctype="multipart/form-data">
		...
		<div class="tab-content"  ng-app="its" >

			<div class="col-sm-offset-7 col-sm-5" style="background:#e7e7e7; min-height: 250px;" >
							      <?php
			...
			<ul class="pager wizard" >
				...
				<li class="next last" style="display:none;"><a href="javascript:void(0)">Last</a></li>
			  	...
			  	<button class="finish btn btn-primary btn-lg" name="submit" value="register" style="display:none;"><a style="float:none;color:white;">Submit</a></button>
